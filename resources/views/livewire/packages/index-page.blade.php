<div class="awan-page">
    <header class="resource-header">
        ...
        <a class="primary-btn" href="{{ route('admin.packages.create') }}" wire:navigate>
                    ...
                    @forelse($packages as $package)
                        <tr wire:key="package-{{ $package->package_id }}">
                            ...
                            <td data-label="Durasi">
                                <span class="package-duration">{{ $package->duration_days }}</span>
                                <small class="table-secondary">hari</small>
                            </td>
                            <td data-label="Harga">
                                <strong class="package-price">Rp {{ number_format($package->price, 0, ',', '.') }}</strong>
                                <small class="table-secondary">Rp {{ number_format($package->price / max($package->duration_days, 1), 0, ',', '.') }}/hari</small>
                            </td>
                            ...
                            <td data-label="Aksi" class="action-column">
                                <div class="table-actions">
                                    <a href="{{ route('admin.packages.edit', $package) }}" class="table-action table-action-secondary" wire:navigate>
                                        Edit Paket
                                    </a>
                                </div>
                            </td>
